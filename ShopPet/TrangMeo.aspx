<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrangMeo.aspx.cs" Inherits="ShopPet.TrangMeo" %>
...
<head runat="server">
    <title></title>
    <link href="assest/css/meo.css" rel="stylesheet" />
...
<body>
    <div class="app">
        ...
        <div class="content">
            <div class="abc">
                <a href="TrangChu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="TrangMeo.aspx"><strong>PHỤ KIỆN CHO MÈO</strong></a>
                    ...
                    <div class="row_1">
                        ...
                        <div class="show">
                            <ul class="list-menu">
                                ...
                                <li><a href="TrangMeo.aspx?type=meo">Phụ kiện cho mèo</a></li>
                            </ul>
                        </div>
                         <br/>
